"""Add invite-only authentication and authorization records.
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_memberships_organization_user", "memberships", ["organization_id", "user_id"]
    )
    op.create_table(
        "invites",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index("ix_invites_organization_email", "invites", ["organization_id", "email"])
    op.create_table(
        "refresh_sessions",
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("user_id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        "ix_audit_events_organization_created", "audit_events", ["organization_id", "created_at"]
    )
...
def downgrade() -> None:
    ...
    op.drop_index("ix_invites_organization_email", table_name="invites")
